...
int main()
{
 ...
 Tarjeta
  ...
  stl.precio() = 44.50;
  std::cout << "Krispín compra 2 de CPP y otros 2 de STL\n";
  ...
  sanani.compra(ada, 6 - 4);	// quita 4 del carrito
  mostrar_carro(std::cout, sanani);
  ...
  ada.precio() = 34.90;
  std::cout << "Rosita compra 2 de POO, 3 de CPP y 1 STL\n";
  rosa.compra(poo, 2);
  rosa.compra(cpp, 3);
  rosa.compra(stl);
  ...
  std::cout << "Rosita compra 1 STL, 1 ADA y 3 CPP\n";
